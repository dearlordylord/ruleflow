...
export const Component = Schema.Union(
  ...
  // Combat Encounter domain
  Combat.CombatEncounterComponent,
  Combat.DistanceComponent,
  Combat.ReadyActionComponent,
  Combat.DefenseStanceComponent,
  Combat.MysteryCastingComponent,
  // Inventory domain
